...
<body>
    ...
    <?php
        ...
        // Digunakan untuk membuka file. Mengembalikan pointer ke file yang dibuka
        $fp = fopen($file,"r");
        if ($fp)
        {
            // Digunakan untuk membaca file baris demi baris
            $baca = fgets($fp,50);

            // untuk menampilkan isi dari $baca
            print ("$baca");
        }

        // Digunakan untuk membuka file tertutup
        fclose($fp);
    ?>
    komentar<?php
        $file = "komentar.txt";
